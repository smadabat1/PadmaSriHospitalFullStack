...
export default function BpCalculationLayout() {
  return (
    <Stack
      screenOptions={{
        headerShown: true,
      ...
      <Stack.Screen
        ...
        options={{
            ...
            headerRight: ({ onPress, canGoBack }) =>
             (
              <TouchableOpacity onPress={() => router.push("/bpTracking/bpHistory")} className="flex flex-row gap-x-2 ml-[-8] items-center">
